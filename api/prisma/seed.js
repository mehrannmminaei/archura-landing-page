...
async function main() {
    ...
    const posts = [
        ...
        },
        {
            ...
            content: '<h2>Why a Content Calendar Matters</h2><p>Consistency is the foundation of content marketing success.</p><h2>Mapping to Funnel Stages</h2><p>Align each piece of content with awareness, consideration, or decision stages.</p>',
        ...
        },
        {
            ...
            content: '<h2>What Is Quality Score?</h2><p>Quality Score is Google\'s rating of ad relevance and landing page experience.</p><h2>How to Improve It</h2><p>Focus on keyword-ad alignment, compelling ad copy, and fast landing pages.</p>',
            authorId: authors[0].id,
        ...
        },
        {
            ...
            content: '<h2>Crawlability</h2><p>Ensure search engines can access and index your important pages.</p><h2>Site Architecture</h2><p>Logical URL structure and internal linking boost discoverability.</p>',
            authorId: authors[0].id,
            categoryId: categories[0].id,
        },
        {
            ...
            content: '<h2>The Power of Story</h2><p>Even B2B buyers respond to compelling narratives.</p><h2>Case Study Framework</h2><p>Structure stories around challenge, solution, and measurable results.</p>',
            authorId: authors[1].id,
            categoryId: categories[1].id,
        },
    ];
